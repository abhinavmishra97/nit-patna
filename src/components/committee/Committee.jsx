  ...
  return (
    <div className="committee-container">
      ...
      <div className="convenors">
        ...
        <li className='odd-list'>Dr. Shailendra K. Mandal, Associate Professor</li>
        ...
        <li className='odd-list'>Ar. Kranti Kumar Maurya, Assistant Professor</li>
